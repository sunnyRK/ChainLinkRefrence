...
import ChainLinkIcon from '../../src/assets/icons/chainlink.png';

// AutoTradecontract : 0xBC629E20D2753eF62A52dE7278bbFCEd720F27b8

// Chainlink Oracle Instance
export function getChainlinkOracle(web3) {
    const abi = '[{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"previousOwner","type":"address"},{"indexed":true,"internalType":"address","name":"newOwner","type":"address"}],"name":"OwnershipTransferred","type":"event"},{"inputs":[],"name":"renounceOwnership","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"string","name":"tokenSymbol","type":"string"},{"internalType":"address","name":"tokenAddress","type":"address"}],"name":"setToken","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"newOwner","type":"address"}],"name":"transferOwnership","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"string","name":"","type":"string"}],"name":"chainlinkTokenMapping","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"tokenSymbol","type":"string"}],"name":"getLatestPrice","outputs":[{"internalType":"int256","name":"","type":"int256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"string","name":"tokenSymbol","type":"string"}],"name":"getLatestPriceTimestamp","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"owner","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"}]';
    const address = "0xd3Ae9308Adf972Edc3C7055C31cc2A6BE29B6676"; //kovan
...
export function getUniswapV2Router02(web3) {
    ...
    const address = "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"; //kovan UniswapV2Router02
    const jsonAbi = JSON.parse(abi);
    const contract = new web3.eth.Contract(jsonAbi, address);    
    return contract;
}
...
export function getUniswapV2Factory(web3) {
    ...
    const address = "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"; //kovan
    const jsonAbi = JSON.parse(abi);
    const contract = new web3.eth.Contract(jsonAbi, address);    
    return contract;
}
...
export function getUniswapV2Library(web3) {
    ...
    const address = "0x8a6fDF4a469283dd548953cAcaEB818d56F21772"; //kovan
    const jsonAbi = JSON.parse(abi);
    const contract = new web3.eth.Contract(jsonAbi, address);  
...
export const TokenInfoArray = [
    {
          'DAI': {
            ...
            "token_symbol":"ZRX",
            "token_contract_address":"0xa36085f69e2889c224210f603d836748e7dc0088",
            "decimals": 18
        },'WETH': {
            "token_symbol":"WETH",
        ...
        'DAI-WETH': {
            "token_symbol":"pair",
            "token_contract_address":"0xBbB8eeA618861940FaDEf3071e79458d4c2B42e3",
            "decimals": 18
        },'DAI-LINK': {
            "token_symbol":"pair",
            "token_contract_address":"0x6dd927415800150397cf8868668ba31fd3716481",
            "decimals": 18
        },'DAI-BAT': {
            "token_symbol":"pair",
            "token_contract_address":"0x8976d75EE1B656b7450e87b7f773524A00f02A89",
            "decimals": 18
        },'LINK-BAT': {
            "token_symbol":"pair",
            "token_contract_address":"0x62bfdB9E733a7dF516F7d4309F4d3B96132D6cC9",
            "decimals": 18
        },'WETH-LINK': {
            "token_symbol":"pair",
            "token_contract_address":"0x5ae45101eB47752Ea0068F432735cF00F6C849bD",
            "decimals": 18
        }
    }
];
  ...
  export const PairInfoArray = [
    {
        'DAI-WETH': {
            "pairaddress":"0xBbB8eeA618861940FaDEf3071e79458d4c2B42e3",
            "token0":"DAI",
            "token1": "WETH"
        },'DAI-LINK': {
            "pairaddress":"0x6dd927415800150397cf8868668ba31fd3716481",
            "token0":"DAI",
            "token1": "LINK"
        },'DAI-BAT': {
            "pairaddress":"0x8976d75EE1B656b7450e87b7f773524A00f02A89",
            "token0":"DAI",
            "token1": "BAT"
        },'LINK-BAT': {
            "pairaddress":"0x62bfdB9E733a7dF516F7d4309F4d3B96132D6cC9",
            "token0":"LINK",
            "token1": "BAT"
        },'WETH-LINK': {
            "pairaddress":"0x5ae45101eB47752Ea0068F432735cF00F6C849bD",
            "token0":"WETH",
            "token1": "LINK"
        }
    }
  ...
  export const tagOptions = [
    {
        ...
        text: (
            <div className="token-pairs-overlap">
              <img src={DaiIcon} className="ui avatar image" alt="coin" />
              <img src={ChainLinkIcon} className="ui avatar image  overlap-image" alt="coin" /> DAI - LINK
            </div>
          ),
        value: 'DAI-LINK',
    },{
        ...
        text: (
            <div className="token-pairs-overlap">
              <img src={ChainLinkIcon} className="ui avatar image" alt="coin" />
              <img src={BatIcon} className="ui avatar image  overlap-image" alt="coin" /> LINK - BAT
            </div>
          ),
        value: 'LINK-BAT',
    },{
        ...
        text: (
            <div className="token-pairs-overlap">
              ...
              <img src={ChainLinkIcon} className="ui avatar image  overlap-image" alt="coin" /> WETH - LINK
            </div>
          ),
        value: 'WETH - LINK',
    }
