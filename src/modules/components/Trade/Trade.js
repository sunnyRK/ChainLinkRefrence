...
const Trade = ({
  ...
  handleInputPrice, amountOut, slippage, handleState, amountOutWithToken, chainlinkRateWithToken,
  onClearClick, chainlinkRate, amountInBalanceText, token0, reserve0, blocking
}) => (
  <BlockUI
    tag="div"
    blocking={blocking}
    ...
    <div className="card trade">
      ...
      <div className="form-field">
        ...
        <Input
          type="input"
          className="form-control"
          value={chainlinkRateWithToken}
          onChange={(event) => {
            handleState({ chainlinkRateWithToken: event.target.value });
          }}
          disabled
        />
